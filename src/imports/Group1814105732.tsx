...
export default function Group() {
  return (
    <div className="relative size-full">
      <div className="absolute content-stretch flex gap-[20px] items-center left-0 top-[160px]">
      ...
      <div className="absolute content-stretch flex flex-col gap-[10px] items-center leading-[0] left-0 top-0 w-[614px]">
