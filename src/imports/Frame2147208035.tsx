...
function Info({ text, text1 }: InfoProps) {
  return (
    <div className="content-stretch flex flex-col gap-px items-start leading-[0] overflow-clip relative shrink-0">
      <div className="flex flex-col font-['DM_Sans:Medium',sans-serif] font-medium h-[22px] justify-center min-w-full relative shrink-0 text-[#131515] text-[18px] w-[min-content]" style={{ fontVariationSettings: "'opsz' 14" }}>
...
export default function Frame() {
  return (
    <div className="relative size-full">
      <div className="absolute content-stretch flex flex-col gap-[72px] items-center left-0 top-[97px] w-[1440px]">
        ...
        <div className="h-[717px] relative shrink-0 w-full">
          ...
          <div className="-translate-x-1/2 absolute bg-[#f7f7f7] blur-[32px] bottom-[-50px] h-[163px] left-1/2 w-[1440px]" data-name="Overlay" />
          <div className="-translate-x-1/2 absolute bg-[#1c1b20] bottom-0 content-stretch flex flex-col items-start left-[calc(50%+0.5px)] overflow-clip px-[34px] py-[16px] rounded-[100px]" data-name="Link - Default">
